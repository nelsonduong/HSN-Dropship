        ...
        public void buttonLogin_Click(object sender, EventArgs e)
        {
            ...
            if (textBoxPassword.Visible == true && textBoxPassword.Enabled == true)
            {
                ...
                if (textBoxPassword.Text == "biscuits")
                {
                    ...
                    ///////////////Today///////////////
                    // AND `ProcessedDate` = '" + dateTimePickerShipDate.Text + "';"
                    if (MySQLConnection.OpenConnection() == true)
                    {
                        MySqlCommand HSNic;
                        HSNic = new MySqlCommand("SELECT Count(`PO Number`) FROM `HSN` WHERE `ShipDate` IS NULL AND `ProcessedDate` = '" + dateTimePickerShipDate.Text + "';", MySQLConnection.connection);
                ...
                if (textBoxPassword.Text == "acct4inv")
                {
                    ...
                    if (MySQLConnection.OpenConnection() == true)
                    {
                        ...
                        //display all PO's that have not been shipped/ASNd
                        int numberOfUploads = Convert.ToInt32(HSNic.ExecuteScalar());
                        labelOutstanding.Text = numberOfUploads.ToString() + " POs Outstanding";
                        MySQLConnection.CloseConnection();
                    }
            ...
            if (MessageBox.Show("Is " + dateTimePickerShipDate.Text + " the correct ship date? ", "Confirm Ship Date", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                else if (MessageBox.Show("Are you sure you want to upload this file?", "Import to Database", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    if (MySQLConnection.OpenConnection() == true)
                    {
                        ...
                        #region Update Buyer Item Nbr & Manufacturer Item Nbr by Supplier Item Nbr
                        /*
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107DTCBLKSOFT', `Manufacturer Item Nbr` = '828063312720' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '297624001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107DTCRYLSOFT', `Manufacturer Item Nbr` = '828063312768' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '297624431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107DTCPRPSOFT', `Manufacturer Item Nbr` = '828063312782' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '297624502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107DTCREDSOFT', `Manufacturer Item Nbr` = '828063312775' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '297624611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107DTCMAGSOFT', `Manufacturer Item Nbr` = '828063412703' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '297624686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPBLK', `Manufacturer Item Nbr` = '828063516722' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPGRN', `Manufacturer Item Nbr` = '828063516746' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPRYL', `Manufacturer Item Nbr` = '828063516760' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPPRP', `Manufacturer Item Nbr` = '828063516784' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPRED', `Manufacturer Item Nbr` = '828063516777' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPPNK', `Manufacturer Item Nbr` = '828063516708' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME107D8GBSPMAG', `Manufacturer Item Nbr` = '828063616705' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305452686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-BLK', `Manufacturer Item Nbr` = '828063301724' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-GRN', `Manufacturer Item Nbr` = '828063301748' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-RYL', `Manufacturer Item Nbr` = '828063401714' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-PRP', `Manufacturer Item Nbr` = '828063301786' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-RED', `Manufacturer Item Nbr` = '828063301779' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-PNK', `Manufacturer Item Nbr` = '828063301700' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-017-MAG', `Manufacturer Item Nbr` = '828063301793' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '305478686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-110D-16GB-BLK', `Manufacturer Item Nbr` = '828063413021' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '310449001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-110D-16GB-BLU', `Manufacturer Item Nbr` = '828063413014' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '310449404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-110D-16GB-PRP', `Manufacturer Item Nbr` = '828063413083' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '310449502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-110D-16GB-RED', `Manufacturer Item Nbr` = '828063413076' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '310449611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-110D-16GB-PNK', `Manufacturer Item Nbr` = '828063413007' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '310449649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-10D-16GB-BLK', `Manufacturer Item Nbr` = '828063512021' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316839001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCBLK', `Manufacturer Item Nbr` = '828063420821' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCGRN', `Manufacturer Item Nbr` = '828063420845' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCRYL', `Manufacturer Item Nbr` = '828063420852' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCPRP', `Manufacturer Item Nbr` = '828063420883' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCRED', `Manufacturer Item Nbr` = '828063420876' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCPNK', `Manufacturer Item Nbr` = '828063420807' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8QS16KCMAG', `Manufacturer Item Nbr` = '828063420869' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '395089686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-10D-16GB-BLU', `Manufacturer Item Nbr` = '828063512014' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316839404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-10D-16GB-PRP', `Manufacturer Item Nbr` = '828063512083' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316839502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-10D-16GB-RED', `Manufacturer Item Nbr` = '828063512076' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316839611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-10D-16GB-PNK', `Manufacturer Item Nbr` = '828063512007' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316839649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-010-BLK', `Manufacturer Item Nbr` = '828063301021' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316871001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-010-BLU', `Manufacturer Item Nbr` = '828063301014' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316871404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-010-PRP', `Manufacturer Item Nbr` = '828063301083' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316871502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-010-RED', `Manufacturer Item Nbr` = '828063301076' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316871611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-TC-010-PNK', `Manufacturer Item Nbr` = '828063301007' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '316871649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-BLK', `Manufacturer Item Nbr` = '828063617726' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-GRN', `Manufacturer Item Nbr` = '828063617740' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-RYL', `Manufacturer Item Nbr` = '828063617764' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-PRP', `Manufacturer Item Nbr` = '828063617788' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-RED', `Manufacturer Item Nbr` = '828063617771' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-PNK', `Manufacturer Item Nbr` = '828063617702' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7F-16GB-MAG', `Manufacturer Item Nbr` = '828063717709' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '328928686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-BLK', `Manufacturer Item Nbr` = '828063412925' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '340915001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-BLU', `Manufacturer Item Nbr` = '828063412918' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '340915404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-PRP', `Manufacturer Item Nbr` = '828063412987' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '340915502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-RED', `Manufacturer Item Nbr` = '828063412970' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '340915611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-PNK', `Manufacturer Item Nbr` = '828063412901' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '340915649';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPBLK', `Manufacturer Item Nbr` = '828063519723' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962001';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPGRN', `Manufacturer Item Nbr` = '828063519747' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962304';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPRYL', `Manufacturer Item Nbr` = '828063519716' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962431';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPPRP', `Manufacturer Item Nbr` = '828063519785' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q16KCAPSPMAG', `Manufacturer Item Nbr` = '828063612202' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '376052686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q16KCAPSPRED', `Manufacturer Item Nbr` = '828063612271' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '376052611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q16KCAPSPPRP', `Manufacturer Item Nbr` = '828063612288' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '376052502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q16KCAPSPRYL', `Manufacturer Item Nbr` = '828063612219' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '376052431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q16KCAPSPBLK', `Manufacturer Item Nbr` = '828063612226' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '376052001';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPRED', `Manufacturer Item Nbr` = '828063519778' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962611';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPPNK', `Manufacturer Item Nbr` = '828063519709' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962649';
                            UPDATE HSN SET `Buyer Item Nbr` = '7D8TCSPFEAPMAG', `Manufacturer Item Nbr` = '828063519792' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '348962686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16TCSPAPBLK', `Manufacturer Item Nbr` = '828063414929' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '371941001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16TCSPAPBLU', `Manufacturer Item Nbr` = '828063414912' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '371941404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16TCSPAPPRP', `Manufacturer Item Nbr` = '828063414981' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '371941502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16TCSPAPRED', `Manufacturer Item Nbr` = '828063414974' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '371941611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16TCSPAPPNK', `Manufacturer Item Nbr` = '828063414905' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '371941649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-BLK', `Manufacturer Item Nbr` = '828063512922' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '372845001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-BLU', `Manufacturer Item Nbr` = '828063512915' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '372845404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-PRP', `Manufacturer Item Nbr` = '828063512984' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '372845502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-RED', `Manufacturer Item Nbr` = '828063512977' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '372845611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9D8TC-PNK', `Manufacturer Item Nbr` = '828063512908' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '372845649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KCAPSPBLK', `Manufacturer Item Nbr` = '828063416923' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '381644001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KCAPSPBLU', `Manufacturer Item Nbr` = '828063416916' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '381644404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KCAPSPPRP', `Manufacturer Item Nbr` = '828063416985' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '381644502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KCAPSPPNK', `Manufacturer Item Nbr` = '828063416909' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '381644649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KCAPSPRED', `Manufacturer Item Nbr` = '828063416978' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '381644611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPBLK', `Manufacturer Item Nbr` = '828063316827' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPGRN', `Manufacturer Item Nbr` = '828063316841' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPPRP', `Manufacturer Item Nbr` = '828063316889' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPRED', `Manufacturer Item Nbr` = '828063316872' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPPNK', `Manufacturer Item Nbr` = '828063316803' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPMAG', `Manufacturer Item Nbr` = '828063316865' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCAPRYL', `Manufacturer Item Nbr` = '828063316858' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '382282B6S';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-BLK', `Manufacturer Item Nbr` = '828063818727' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-GRN', `Manufacturer Item Nbr` = '828063818741' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-RYL', `Manufacturer Item Nbr` = '828063818765' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-PRP', `Manufacturer Item Nbr` = '828063818789' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-RED', `Manufacturer Item Nbr` = '828063818772' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-PNK', `Manufacturer Item Nbr` = '828063818703' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-7Q-16GB-F-MAG', `Manufacturer Item Nbr` = '828063918700' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405311686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-PNK', `Manufacturer Item Nbr` = '828063302806' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-MAG', `Manufacturer Item Nbr` = '828063302868' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-RYL', `Manufacturer Item Nbr` = '828063302851' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-BLK', `Manufacturer Item Nbr` = '828063302820' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-GRN', `Manufacturer Item Nbr` = '828063302844' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-RED', `Manufacturer Item Nbr` = '828063302875' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-PC-018-PRP', `Manufacturer Item Nbr` = '828063302882' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405305502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KC25-BLK', `Manufacturer Item Nbr` = '828063417920' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401565001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KC25-BLU', `Manufacturer Item Nbr` = '828063417913' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401565404';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KC25-PRP', `Manufacturer Item Nbr` = '828063417982' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401565502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KC25-RED', `Manufacturer Item Nbr` = '828063417975' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401565611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME9Q16KC25-PNK', `Manufacturer Item Nbr` = '828063417982' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401565649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKBLK', `Manufacturer Item Nbr` = '828063417821' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKGRN', `Manufacturer Item Nbr` = '828063417845' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKRYL', `Manufacturer Item Nbr` = '828063417852' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKPRP', `Manufacturer Item Nbr` = '828063417883' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKRED', `Manufacturer Item Nbr` = '828063417876' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKPNK', `Manufacturer Item Nbr` = '828063417807' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q8TCBLKMAG', `Manufacturer Item Nbr` = '828063417869' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '413848686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q5M16KCBLK', `Manufacturer Item Nbr` = '828063712223' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '407780001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q5M16KCMAG', `Manufacturer Item Nbr` = '828063712209' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '407780686';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q5M16KCRYL', `Manufacturer Item Nbr` = '828063712216' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '407780431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q5M16KCRED', `Manufacturer Item Nbr` = '828063712278' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '407780611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME10Q5M16KCPRP', `Manufacturer Item Nbr` = '828063712285' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '407780502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-89W-BK-16GB', `Manufacturer Item Nbr` = '828063540925' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401789';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME-101W-DK-16GB', `Manufacturer Item Nbr` = '828063540123' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '401792';
                         *  UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCBLK', `Manufacturer Item Nbr` = '828063317824' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144001';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCGRN', `Manufacturer Item Nbr` = '828063317848' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144304';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCRYL', `Manufacturer Item Nbr` = '828063317855' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144431';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCPRP', `Manufacturer Item Nbr` = '828063317886' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144502';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCRED', `Manufacturer Item Nbr` = '828063317879' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144611';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCPNK', `Manufacturer Item Nbr` = '828063317800' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144649';
                            UPDATE HSN SET `Buyer Item Nbr` = 'ME8Q16TCMAG', `Manufacturer Item Nbr` = '828063317862' WHERE `ProcessedDate` = '" + sdate + "' AND `Supplier Item Nbr` = '405144686';
                         */
                        #endregion
                        ...
                        #endregion
                        ///////////////Today///////////////
                        #region Select POs that have not been processed for TODAY
                        HSNc = new MySqlCommand("SELECT Count(`PO Number`) FROM `HSN` WHERE `ShipDate` IS NULL AND `ProcessedDate` = '" + dateTimePickerShipDate.Text + "';", MySQLConnection.connection);
        ...
        private void buttonSummary_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Is " + dateTimePickerShipDate.Text + " the correct ship date? ", "Confirm Ship Date", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                if (MySQLConnection.OpenConnection() == true)
                {
                    ...
                    {
                        //Joey's directory: C:\Users\Public
                        //Office directory: \\DATA\DATA Public\Dropship Daily FILES
                        ...
                        DSOpen.InitialDirectory = @"C:\Users\Public";
